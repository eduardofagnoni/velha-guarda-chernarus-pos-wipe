...
start DayZServer_x64.exe -config=serverDZ.cfg -port=2302 -profiles=ServerProfile "-mod=@CF;@Dabs Framework;@DayZ Editor Loader;@VPPAdminTools;@AC-Mod-Pack;@Velha_Guarda_Chernarus;@Basic Territories;@BurningBarrels;@FlipTransport;@Garage;@GarageFix;@Trader;@TraderFixesAndFeatures;@VanillaPlusPlusMap;@PVEZ Reloaded;@PVEZMarkersOnVPPMap;@BetterVendingMachines;@LIGHTS;@Code Lock;@MuchStuffPack;@BuilderItems;@Care Packages;@BR ARMY CLOTHING;@SpawnerBubaku;@SchanaModParty" -cpuCount=4 -dologs -adminlog -netlog -freezecheck
